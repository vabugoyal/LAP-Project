...
<div class="jumbotron"><div class="container-fluid">
            ...
            <p class="text-center">
                ...
                <p class="text-justify">
                        During the course of the game you will be shown series of email and you have to identify whether the email is genuine or phishing email. There are fifty trials in game and after each trial the participant will get feedback. <br>In all, you will gain +1 points if your answer is correct, whereas you will get -1 point for a wrong answer.
